/*
 * File:   avrnacl-20130514/highspeed/sha512/crypto_hash_sha512.c
...
int crypto_hashblocks_sha512(unsigned char *statebytes,const unsigned char *in,crypto_uint16 inlen)
{
  ...
  while (inlen >= 128) 
  {
    ...
    bigint_add64(state[0].v, state[0].v, state_safe[0].v);  
    bigint_add64(state[1].v, state[1].v, state_safe[1].v);  
    bigint_add64(state[2].v, state[2].v, state_safe[2].v);  
    bigint_add64(state[3].v, state[3].v, state_safe[3].v);  
    bigint_add64(state[4].v, state[4].v, state_safe[4].v);  
    bigint_add64(state[5].v, state[5].v, state_safe[5].v);  
    bigint_add64(state[6].v, state[6].v, state_safe[6].v);  
    bigint_add64(state[7].v, state[7].v, state_safe[7].v);

    state_safe[0] = state[0];
    state_safe[1] = state[1];
    state_safe[2] = state[2];
    state_safe[3] = state[3];
    state_safe[4] = state[4];
    state_safe[5] = state[5];
    state_safe[6] = state[6];
    state_safe[7] = state[7];
